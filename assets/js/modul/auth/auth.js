...
function auth_to(page,title,url) {
    $('.authpage.showin').removeClass('d-flex');
    $('.authpage.showin').addClass('hidin');
    $('.authpage.showin').removeClass('showin');
    $(page).removeClass('hidin');
    $(page).addClass('d-flex');
    $(page).addClass('showin');
    window.history.pushState('Authentifikasi', title, BASE_URL + url);
}