<form method="POST" action="<?= base_url('master_function/set_pengepul') ?>" id="form_pengepul"
  ...
  <div class="mb-15">
    ...
    <div class="mh-375px scroll-y me-n7 pe-7">
      ...
      <!--begin::User-->
      <label for="check-<?= $row->id_user; ?>"
        class="d-flex flex-stack py-5 border-bottom border-gray-300 border-bottom-dashed cursor-pointer">
        <!--begin::Details-->
        <div class="d-flex align-items-center">
          <!--begin::Avatar-->
          <div class="symbol symbol-35px symbol-circle">
            <input type="checkbox" name="id_user[]" class="check-id" value="<?= $row->id_user; ?>"
              id="check-<?= $row->id_user; ?>" <?= (in_array($row->id_user,$choose)) ? 'checked' : ''; ?>>
          </div>
          <!--end::Avatar-->
          <!--begin::Details-->
          <div class="ms-6">
...
<div class="modal-footer">
  <button type="button" id="btn_simpan_pengepul" onclick="submit_form(this,'#form_pengepul',2)"
