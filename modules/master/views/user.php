                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="d-flex justify-content-end flex-shrink-0">
                                                        <button type="button" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" title="Ubah data user" onclick="edit_user(this,<?= $row->id_user; ?>)" data-bs-toggle="modal" data-bs-target="#kt_modal_user">
