                            ...
                            <div class="card card-xl-stretch mb-xl-8">
                                ...
                                <div class="card-body pt-5">
                                    ...
                                    <div class="d-flex flex-stack flex-column" style="width : 6.035">
                                        <!--begin::Title-->
                                        <h4 class="fw-bold text-primary m-0 my-5" style="font-size : 45px">
                                            <?= month_from_number(date('m')) . ' ' . date('Y') ?></h4>
                                        <!--end::Menu-->
                                    </div>
                                    <!--end::Heading-->
                                            ...
                                            <div class="card card-xl-stretch mb-xl-8">
                                                ...
                                                <div class="card-body pt-5">
                                                    ...
                                                    <div class="d-flex flex-center w-100 flex-column" style="height : 170px;">
                                                        <span class="text-primary " style="font-size : 60px;"><?= simple_number($jumlah['admin']) ?></span>
                                        ...
                                        <div class="col-xl-4">
                                            ...
                                            <div class="card card-xl-stretch mb-xl-8">
                                                ...
                                                <div class="card-body pt-5">
                                                    ...
                                                    <!--begin::Chart-->
                                                    <div class="d-flex flex-center w-100 flex-column" style="height : 170px;">
                                                        <span class="text-primary " style="font-size : 60px;"><?= simple_number($jumlah['user']) ?></span>
                                        ...
                                        <div class="col-xl-4">
                                            ...
                                            <div class="card card-xl-stretch mb-xl-8">
                                                ...
                                                <div class="card-body pt-5">
                                                    ...
                                                    <!--begin::Chart-->
                                                    <div class="d-flex flex-center w-100 flex-column" style="height : 170px;">
                                                        <span class="text-primary " style="font-size : 60px;"><?= simple_number($jumlah['pengepul']) ?></span>
                                        ...
                                        <div class="col-xl-4">
                                            ...
                                            <div class="card card-xl-stretch mb-xl-8">
                                                ...
                                                <div class="card-body pt-5">
                                                    ...
                                                    <!--begin::Chart-->
                                                    <div class="d-flex flex-center w-100 flex-column" style="height : 170px;">
                                                        <span class="text-primary " style="font-size : 60px;"><?= simple_number($pribadi->poin) ?></span>
                                                        <span class="text-muted"><?= $pribadi->poin ?> Poin</span>
                                                    </div>
                                                    <!--end::Chart-->
                                                    <button class="btn btn-primary w-100" onclick="tukar_poin(<?= $pribadi->poin ?>)" data-bs-toggle="modal" data-bs-target="#kt_modal_voucher">Tukar Poin</button>
                                                </div>
                                                <!--end::Body-->
                                            </div>
                                            <!--end::Card widget 19-->
